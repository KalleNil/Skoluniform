...
class tomsida {
    constructor() {
        ...
        document.write('<link rel="stylesheet" href="./css/w3.css">');
        document.write('<link rel=icon href=./images/SuF.png sizes="any" type="image/svg+xml">');
        document.write('<script src="./assets/javascript/users.js"></script');
        ...
        document.write('<a href="Home.html"> <img src="./images/SuF.png" height="70"></a>');
        ...
        document.write('<img  class="w3-left" src="./images/SuF.png" alt="alt" height="138"/>');
